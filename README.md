Update 29.11.25 — API & Database

- Перешли на Redux Thunk для работы с асинхронными действиями.
- Написали API-запросы для работы с заказами и продуктами.
- Настроена интеграция с Firebase Database: создание, обновление, удаление заказов и продуктов.
- Добавлена обработка ошибок и валидация данных через Zod.
- Добавлен компонент ActiveSessionsCounter — счетчик активных сессий

---

Update 25.11.25 — Cleaning & Refactoring

- Полностью провёл рефакторинг кода: удалил лишние участки, упрощённые и оптимизированные компоненты.
- Вынес основную логику в кастомные хуки для удобства переиспользования.
- Создал отдельные компоненты для popup’ов: CreateOrderPopup и CreateProductPopup.
